...
def run_experiments(
    *, test_series: int, train_series: int, type_env: str,
    ...
    trace_id_test: int, network_id_test: int, checkpoint_to_load: str):
    """
    """
    ...
    for experiment_str, env_config, learn_config in zip(
        ...
        pp.pprint(env_configs)

    # trained ray agent should always be simulation
    # however the agent outside it can be kube agent or
...
def main(local_mode: bool, test_series: int, train_series: int,
         ...
         network_id_test: int, checkpoint_to_load: str):
    """[summary]
    ...
    run_experiments(
        ...
        trace_id_test=trace_id_test, network_id_test=network_id_test,
