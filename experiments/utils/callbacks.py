...
class CloudCallback(DefaultCallbacks):
    ...
    """
    callback for saving my own metrics
    ...
    def on_episode_start(
        ...
        **kwargs,
        ...
        # overusage
        episode.user_data["num_overused"] = []
        episode.hist_data["num_overused"] = []
    ...
    def on_episode_step(
        ...
        **kwargs,
        ...
        if type(episode._last_infos) == dict:
            ...
            users_distances = episode._last_infos[agentid]['users_distances']
            ...
            # overusage
            num_overused = episode._last_infos[agentid]['num_overused']
            episode.user_data["num_overused"].append(num_overused)
    ...
    def on_episode_end(
        ...
        **kwargs,
        ...
        num_overusage_avg = np.mean(episode.user_data["num_overused"])
        ...
        episode_reward_latency = [a[
            'reward_latency']for a in episode.user_data[
                "rewards"]]
        episode_reward_overusage = [a[
            "reward_overusage"] for a in episode.user_data["rewards"]]

        reward_consolidation_mean = np.mean(episode_reward_consolidation)
        reward_overusge_mean = np.mean(episode_reward_overusage)
        ...
        reward_overusge_sum = np.sum(episode_reward_overusage)
        ...
        episode.custom_metrics['num_overused'] = num_overusage_avg
        ...
        episode.custom_metrics['reward_overusage_mean'] = reward_overusge_mean
        ...
        episode.custom_metrics['reward_overusage_sum'] = reward_overusge_sum
